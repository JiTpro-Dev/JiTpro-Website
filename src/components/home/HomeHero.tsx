    ...
    <section className="relative isolate overflow-hidden bg-jp-background px-6 pt-20 pb-12 sm:px-8 sm:pt-24 sm:pb-14 lg:px-10 lg:pt-28 lg:pb-16">
      ...
      <div className="relative mx-auto max-w-7xl">
        {/* The headline is the composition's opening — centered, the page's
            one display-scale moment (Decision Log 2026-08-27). No eyebrow
        ...
        <div className={rise(0).className} style={rise(0).style}>
          <h1 className="mx-auto max-w-[30ch] text-center font-heading text-[2.125rem] font-extrabold leading-[1.06] tracking-[-0.025em] text-balance text-jp-text-primary sm:text-[3rem] lg:text-[3.5rem] lg:leading-[1.04] xl:text-[4rem] xl:tracking-[-0.03em]">
            ...
            <span className="mt-2 block text-jp-brand-amber">
          ...
          {/* The approved hand-drawn underline (Decision Log 2026-08-27, as
              refined the same day): one calligraphic stroke, drawn as a FILLED
              silhouette rather than a stroked path so the body itself tapers —
              fine point at the left, most weight through the center, released
              to a fine point at the right — over one subtle asymmetric sweep.
              Token amber via currentColor. Static by design. */}
          <svg
            aria-hidden="true"
            viewBox="0 0 420 14"
            preserveAspectRatio="none"
            className="mx-auto mt-4 block h-3 w-64 max-w-full text-jp-brand-amber sm:mt-5 sm:w-[25rem] lg:w-[30rem] xl:w-[34rem]"
          >
            <path
              d="M6 10 C 90 5.4, 160 3, 230 3 C 300 3, 366 5.2, 414 6.8 C 368 7.6, 302 7.6, 232 7.6 C 164 7.6, 92 8.6, 6 10 Z"
              fill="currentColor"
            />
          </svg>
        </div>
